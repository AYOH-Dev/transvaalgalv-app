...
export default function Receipts({ onLogout }: { onLogout?: () => void }) {
  ...
  return (
    <div>
      ...
      <div className="deprecation-banner" role="status">
        ...
        <div>
          <strong>This page is being retired.</strong> Please use the <Link to="/yard">Yard</Link> page for receiving. Receipts will be removed in a future update.
        </div>
      </div>
